package advent_of_code.event.year_2019.__03__crossed_wires;
...
public class SolutionTests
{
    ...
    void exampleTwo()
    {
        ...
        assertEquals(610, new Solution().partTwo(inputLines));
    }
    ...
    void exampleThree()
    {
        ...
        assertEquals(410, new Solution().partTwo(inputLines));
    }
    ...
    void tinyWireIntersection()
    {
        ...
        assertEquals(8, new Solution().partTwo(inputLines));
    }
}
